 ...
 *  state "I2CDevice::" followed by the type.
 *************************************************************************************************/
public:
    ...
    enum InterState {ITEnable, ITDisable};      // Enumerate state for enabling/disabling
                                                // interrupts
    enum CommLock {Communicating, Free};        // Enumerate state for indicating if device is
                                                // communicating
    ...
    typedef struct {            // I2C Form structure, used to manage I2C Communication interrupts
        ...
        union   {                               // Union used to contain the
            uint8_t               *ptr8bit;     //
            GenBuffer<uint8_t>    *ptrGenBuf;   //
        };

        enum DataType {                 // Enumerate type to support union
            Array8bit       = 0,        // Set for 8bit array (union points to 8bit array)
            GenBuffer8bit   = 1         // Set for GenBuffer class pointer (union points to
                                        // GenBuffer)
        } UnionType;                    // Name of enumerate within structure
        ...
        DevFlt          *Flt;               // Provide a pointer to a I2CDevice::DevFlt for the
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                                ...
                                //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        I2CDevice(I2C_HandleTypeDef *I2C_Handle, GenBuffer<Form> *FormBuffer,
 ...
 *   -----------
 *  The following are functions scoped within the "I2CDevice" class, which are generic; this means
...
protected:  /**************************************************************************************
    ...
    void FormWGenBuffer(Form *RequestForm, GenBuffer<uint8_t> *genBuff);
